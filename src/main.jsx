  ...
  return (
    <main className="app-shell">
      <section className="intro-panel">
        ...
        <p>
          Mobile-first prototype for local ComfyUI workflows. Text→Image submits real ComfyUI jobs; Queue and Feed read ComfyUI history. Future image, video, music, cloud, and Civitai browsing controls stay visible as coming-soon roadmap items.
        </p>
      </section>
